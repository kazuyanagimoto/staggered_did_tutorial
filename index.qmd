...
Note: The data set used in Stata/R demonstrations (`cicala_aer_2022_ready.dta`) come from Cicala (AER, 2022) under the CC BY-NC 4.0 License. The original data are hourly observations but are converted to daily-level observations by Yoshifumi Konishi.
