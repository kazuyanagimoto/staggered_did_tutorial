...
bench_sim_stata |>
  ...
  cols_label(.list = list(time_stata = "Time (mm:ss:mmm)",
                          num_eval_stata = "Num. Evaluation",
                          time_r = "Time (mm:ss:mmm)",
                          num_eval_r = "Num. Evaluation")) |>
  tab_spanner(label = md("**Stata**"), columns = c("time_stata", "num_eval_stata")) |>
  tab_spanner(label = md("**R**"), columns = c("time_r", "num_eval_r"))
```
